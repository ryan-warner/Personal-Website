function Background(props) {
    ...
    return (
        <div className="h-5/6 w-full bg-transparent overflow-hidden z-0 relative">
            <div className={(height > width ? "h-[265%] w-auto " :"w-[265%] h-auto " ) + "absolute aspect-square top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] isolate mix-blend-screen"}>
            ...
            <div className="absolute inset-x-0 md:-top-[10%] -top-[2%] w-[90%] h-full flex flex-col justify-center md:p-16 p-6 gap-8">
